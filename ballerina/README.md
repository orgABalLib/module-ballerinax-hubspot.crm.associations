...
2. If you intend to use private apps for API access, note that this feature is available on all HubSpot plans. However, certain CRM association features and API rate limits may vary based on your subscription tier (Starter, Professional, or Enterprise).
...
6. Navigate to the Scopes tab and select the required scopes for CRM associations (e.g., `crm.objects.contacts.read`, `crm.objects.contacts.write`, and other relevant object scopes).
...
3. [CRM association management](https://github.com/ballerina-platform/module-ballerinax-hubspot.crm.associations/tree/main/examples/crm-association-management) - Shows how to manage associations between different CRM records in HubSpot.