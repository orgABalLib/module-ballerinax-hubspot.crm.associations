...
2. Note that while HubSpot offers a free CRM tier, access to certain API features and higher rate limits may require a Professional or Enterprise plan subscription.
...
8. After the app is created, your access token will be displayed. Click **Show token** to reveal it, then copy the token.
...
2. [Create read associations](https://github.com/ballerina-platform/module-ballerinax-hubspot.crm.associations/tree/main/examples/create-read-associations) - Illustrates creating and retrieving CRM associations between records.
3. [CRM association management](https://github.com/ballerina-platform/module-ballerinax-hubspot.crm.associations/tree/main/examples/crm-association-management) - Shows how to manage associations between different CRM objects in HubSpot.
